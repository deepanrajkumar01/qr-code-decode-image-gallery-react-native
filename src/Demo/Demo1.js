...
class Demo extends React.Component {
  ...
  renderPage1 = (item, index) => {
    return (
      <View
        style={{ flex: 1, margin: 5, padding: 3, backgroundColor: "orange" }}
      >
        ...
        {tabs.map((item, index) => {
          ...
          return (
            ...
            <TouchableOpacity
              ...
              onPress={() => goToTab(item, index)}
            >
              <Text style={{ ...{ color: "#333" }, ...tabBarItemActiveStyle }}>
                {item.title}
              </Text>
            </TouchableOpacity>
          );
      ...
      <>
        <SafeAreaView style={{ flex: 1 }}>
          <ScrollView>
            ...
            <ScrollTab tabs={tabs1} style={{ height: 120 }}>
              <View style={styles.tabPageStyle}>
                <Text>tab1</Text>
              </View>
              <View style={styles.tabPageStyle}>
            ...
            <ScrollTab tabs={tabs2} style={{ height: 120 }}>
              {this.renderPage}
            </ScrollTab>
